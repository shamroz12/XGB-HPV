...
with tab1:
    ...
    if run_scan and fasta:
        ...
        # Title
        elements.append(Paragraph("HPV EPIPRED – Epitope Prediction Report", styles['Title']))
        elements.append(Spacer(1,20))

        elements.append(Paragraph(
                "AI-driven prediction of MHC-I epitopes from protein sequence.",
                styles['Normal']
        ))
        ...
        # ==========================
        # TOP EPITOPES SECTION
        # ==========================

        elements.append(Paragraph("Top High-Confidence Epitopes", styles['Heading2']))
        elements.append(Spacer(1,10))
        ...
        elements.append(Paragraph(
                "Generated by HPV EPIPRED – AI-based immunoinformatics platform",
                styles['Normal']
        ))

        elements.append(Paragraph(
                "Developer: Shamroz Abrar",
                styles['Normal']
        ))
